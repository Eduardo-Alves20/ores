...
const { moduleBridgeLimiter } = require("../../middlewares/rateLimiters");

const router = express.Router();

router.get("/modulos/:slug/acessar", requireAuth, moduleBridgeLimiter, ModulosPageController.bridge);
