(function () {
  ...
  try {
    ...
    ensureCollection("ORES", "_bootstrap");
    log("Mongo for ORES is ready.");
  } catch (error) {
    print("[ores-mongo-init] FATAL: " + String(error && error.stack ? error.stack : error));
    quit(1);
  }
})();
